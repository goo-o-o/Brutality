...
public class SpellSelectionGui implements IGuiOverlay {
    ...
    private static final Logger log = LoggerFactory.getLogger(SpellSelectionGui.class);
    ...
    public static void renderSpellSelection(GuiGraphics gui, Player player, ItemStack tome) {
        ...
        for (int i = -half; i <= half; i++) {
            ...
            float progress = SpellCooldownTracker.getCooldownProgress(player, entry.spell()); // 0 = just started, 1 = finished
