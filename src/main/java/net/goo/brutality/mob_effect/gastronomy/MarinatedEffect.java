...
public class MarinatedEffect extends MobEffect {

    public MarinatedEffect(MobEffectCategory pCategory, int pColor) {
    ...
    public void applyEffectTick(LivingEntity pLivingEntity, int pAmplifier) {
        ...
        if (pLivingEntity.level() instanceof ServerLevel serverLevel) {
            serverLevel.sendParticles(BrutalityParticles.OILED_PARTICLE.get(),
