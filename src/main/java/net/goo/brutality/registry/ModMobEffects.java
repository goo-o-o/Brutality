...
public class ModMobEffects {
    ...
    public static final RegistryObject<MobEffect> NEUTRAL = EFFECTS.register("neutral",
            () -> new NeutralEffect(MobEffectCategory.BENEFICIAL, BrutalityTooltipHelper.rgbToInt(new int[]{150, 150, 150})));
    public static final RegistryObject<MobEffect> HAPPY = EFFECTS.register("happy",
            () -> new HappyEffect(MobEffectCategory.BENEFICIAL, BrutalityTooltipHelper.rgbToInt(new int[]{255, 220, 20})));
    public static final RegistryObject<MobEffect> SAD = EFFECTS.register("sad",
            () -> new SadEffect(MobEffectCategory.BENEFICIAL, BrutalityTooltipHelper.rgbToInt(new int[]{0, 50, 150})));
    public static final RegistryObject<MobEffect> ANGRY = EFFECTS.register("angry",
            () -> new AngryEffect(MobEffectCategory.BENEFICIAL, BrutalityTooltipHelper.rgbToInt(new int[]{255, 40, 0})));
