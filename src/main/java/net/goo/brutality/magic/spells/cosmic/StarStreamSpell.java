...
import static net.goo.brutality.magic.IBrutalitySpell.SpellCategory.TARGET;
...
public class StarStreamSpell extends BrutalitySpell {
    ...
    public boolean onCastTick(Player player, ItemStack stack, int spellLevel) {
        if (player.level() instanceof ServerLevel serverLevel) {
            ...
            serverLevel.playSound(null, player.getX(), player.getY(0.5), player.getZ(), BrutalityModSounds.BASS_BOP.get(), SoundSource.AMBIENT,
