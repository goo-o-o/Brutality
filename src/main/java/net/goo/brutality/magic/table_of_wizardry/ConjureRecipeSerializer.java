...
public class ConjureRecipeSerializer implements RecipeSerializer<ConjureRecipe> {
    ...
    public @NotNull ConjureRecipe fromJson(ResourceLocation id, JsonObject json) {
        ...
        IBrutalitySpell spell = BrutalityModSpells.getSpell(id);
        ...
        if (spell == null) {
            ...
            if (json.has("output")) {
                ...
                spell = BrutalityModSpells.getSpell(altId);
            }
        }
        ...
        return new ConjureRecipe(id, ingredients, entities, mana, spell);
    }
    @Override
