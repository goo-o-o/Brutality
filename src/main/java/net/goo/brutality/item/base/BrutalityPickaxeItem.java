...
public class BrutalityPickaxeItem extends PickaxeItem implements BrutalityGeoItem {
    ...
    public BrutalityPickaxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
    ...
    public BrutalityItemCategories category() {
        return BrutalityItemCategories.PICKAXE;
    }
