...
public class BrutalitySwordItem extends SwordItem implements BrutalityGeoItem {
    ...
    public BrutalitySwordItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
