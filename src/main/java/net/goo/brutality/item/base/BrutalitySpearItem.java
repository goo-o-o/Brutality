...
public class BrutalitySpearItem extends AxeItem implements BrutalityGeoItem {
    ...
    public BrutalitySpearItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
