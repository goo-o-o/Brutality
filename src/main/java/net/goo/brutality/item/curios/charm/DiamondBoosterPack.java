...
public class DiamondBoosterPack extends BrutalityCurioItem {


    public DiamondBoosterPack(Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
