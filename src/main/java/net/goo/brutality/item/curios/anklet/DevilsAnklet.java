...
public class DevilsAnklet extends BrutalityAnkletItem {


    public DevilsAnklet(Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    UUID DEVILS_ANKLET_DODGE_UUID = UUID.fromString("385c1f5b-1e50-4c28-bb9e-39198e2847da");
