...
public class BrokenClock extends BrutalityCurioItem {
    public BrokenClock(Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
    ...
    public boolean canEquip(SlotContext slotContext, ItemStack stack) {
        return CuriosApi.getCuriosInventory(slotContext.entity()).map(handler ->
            handler.isEquipped(itemStack -> itemStack.getItem() instanceof BrokenClock)
