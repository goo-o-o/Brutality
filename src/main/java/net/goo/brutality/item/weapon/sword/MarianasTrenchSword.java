...
public class MarianasTrenchSword extends BrutalitySwordItem {
    public MarianasTrenchSword(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
