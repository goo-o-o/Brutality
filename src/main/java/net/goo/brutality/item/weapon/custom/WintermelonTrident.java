...
public class WintermelonTrident extends BrutalityTridentItem {
    ...
    public WintermelonTrident(Properties pProperties, float attackDamageModifier, float attackSpeedModifier, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
