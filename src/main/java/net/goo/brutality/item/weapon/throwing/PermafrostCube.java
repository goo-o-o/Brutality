...
public class PermafrostCube extends BrutalityThrowingItem {


    public PermafrostCube(int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    public EntityType<? extends Projectile> getThrownEntity() {
        return BrutalityModEntities.PERMAFROST_CUBE.get();
    }
