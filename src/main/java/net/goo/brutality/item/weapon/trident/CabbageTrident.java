...
import net.goo.brutality.entity.projectile.trident.physics_projectile.ThrownCabbage;
...
public class CabbageTrident extends BrutalityTridentItem {
    ...
    public CabbageTrident(float attackDamageModifier, float attackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
    ...
    public void launchProjectile(Level pLevel, Player player, ItemStack pStack) {
        ...
        ThrownCabbage thrownEntity = new ThrownCabbage(pLevel, player, pStack, BrutalityModEntities.THROWN_CABBAGE_ENTITY.get());
