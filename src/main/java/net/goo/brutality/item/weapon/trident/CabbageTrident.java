...
import net.goo.brutality.entity.custom.projectile.trident.physics_projectile.ThrownCabbage;
...
public class CabbageTrident extends BrutalityTridentItem {
    ...
    public CabbageTrident(float attackDamageModifier, float attackSpeedModifier, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
