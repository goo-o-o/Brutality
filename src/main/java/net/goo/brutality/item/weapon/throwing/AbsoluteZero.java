...
public class AbsoluteZero extends BrutalityThrowingItem {


    public AbsoluteZero(int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    public EntityType<? extends Projectile> getThrownEntity() {
        return BrutalityModEntities.ABSOLUTE_ZERO.get();
    }
