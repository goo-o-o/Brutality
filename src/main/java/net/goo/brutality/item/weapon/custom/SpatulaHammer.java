...
public class SpatulaHammer extends BrutalityHammerItem implements BrutalityGeoItem {
    ...
    public SpatulaHammer(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
