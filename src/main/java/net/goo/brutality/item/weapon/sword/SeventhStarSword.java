...
public class SeventhStarSword extends BrutalitySwordItem {
    ...
    public SeventhStarSword(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
