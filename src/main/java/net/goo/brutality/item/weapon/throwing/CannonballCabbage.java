...
public class CannonballCabbage extends BrutalityThrowingItem {


    public CannonballCabbage(int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    public EntityType<? extends Projectile> getThrownEntity() {
        return BrutalityModEntities.CANNONBALL_CABBAGE.get();
    }
