...
public class TheCloud extends BrutalityGenericItem {
    ...
    public TheCloud(Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        pPlayer.getCooldowns().addCooldown(this, 5 * 60 * 20);
