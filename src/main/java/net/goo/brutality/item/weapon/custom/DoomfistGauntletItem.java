...
public class DoomfistGauntletItem extends BrutalityGenericItem {
    ...
    public DoomfistGauntletItem(Properties pProperties, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
