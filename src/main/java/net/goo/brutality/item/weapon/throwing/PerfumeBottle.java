...
public class PerfumeBottle extends BrutalityThrowingItem {


    public PerfumeBottle(int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    public EntityType<? extends Projectile> getThrownEntity() {
        ...
        return BrutalityModEntities.PERFUME_BOTTLE.get();
    }
