...
public class DiamondKnifeSword extends BrutalitySwordItem {
    ...
    public DiamondKnifeSword(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
