...
public class DiamondKnifeSword extends BrutalitySwordItem {
    ...
    public DiamondKnifeSword(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
