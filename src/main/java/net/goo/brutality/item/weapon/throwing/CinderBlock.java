...
public class CinderBlock extends BrutalityThrowingItem {


    public CinderBlock(int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    public EntityType<? extends Projectile> getThrownEntity() {
        return BrutalityModEntities.CINDER_BLOCK.get();
    }
