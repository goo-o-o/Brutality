...
public class CrimsonDelight extends BrutalityThrowingItem {


    public CrimsonDelight(int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<BrutalityTooltipHelper.ItemDescriptionComponent> descriptionComponents) {
    ...
    public EntityType<? extends Projectile> getThrownEntity() {
        return BrutalityModEntities.CRIMSON_DELIGHT.get();
    }
