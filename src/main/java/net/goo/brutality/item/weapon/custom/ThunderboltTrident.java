...
public class ThunderboltTrident extends BrutalityTridentItem {
    ...
    public ThunderboltTrident(Properties pProperties, float attackDamageModifier, float attackSpeedModifier, String identifier, Rarity rarity, List<BrutalityTooltipHelper.DescriptionComponent> descriptionComponents) {
