...
public class ThrownCabbage extends BrutalityAbstractPhysicsTrident implements BrutalityGeoEntity {
    ...
    public ThrownCabbage(EntityType<? extends BrutalityAbstractTrident> pEntityType, Player player, Level pLevel) {
