...
public class ThrownBiomechReactor extends BrutalityAbstractPhysicsProjectile implements BrutalityGeoEntity {
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (this.getOwner() instanceof LivingEntity owner) {
            for (LivingEntity livingEntity : level().getNearbyEntities(LivingEntity.class,
                ...
                livingEntity.hurt(livingEntity.damageSources().explosion(owner, livingEntity), 15);
