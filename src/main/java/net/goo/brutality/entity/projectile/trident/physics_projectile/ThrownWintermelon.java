...
public class ThrownWintermelon extends BrutalityAbstractPhysicsTrident implements BrutalityGeoEntity {

    public ThrownWintermelon(EntityType<? extends BrutalityAbstractTrident> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public ThrownWintermelon(EntityType<? extends BrutalityAbstractTrident> pEntityType, Player player, Level pLevel) {
