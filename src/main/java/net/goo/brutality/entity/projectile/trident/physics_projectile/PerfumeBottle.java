...
public class PerfumeBottle extends BrutalityAbstractPhysicsTrident implements BrutalityGeoEntity {

    public PerfumeBottle(EntityType<? extends BrutalityAbstractTrident> pEntityType, Level pLevel) {
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (isExplosive) {
            ...
            if (level() instanceof ServerLevel serverLevel) {
                serverLevel.sendParticles(BrutalityModParticles.PERFUME_PARTICLE.get(), loc.x, loc.y, loc.z, 200, radius, radius, radius, 0);
            }
