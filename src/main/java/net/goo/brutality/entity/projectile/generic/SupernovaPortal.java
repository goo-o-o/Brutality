...
public class SupernovaPortal extends Entity implements BrutalityGeoEntity {
    ...
    @Override
    public <T extends Entity & BrutalityGeoEntity, R extends GeoEntityRenderer<T>> void initGeo(Consumer<EntityRendererProvider<T>> consumer, Class<R> rendererClass) {
        BrutalityGeoEntity.super.initGeo(consumer, BrutalityEndPortalEntityRenderer.class);
    }
