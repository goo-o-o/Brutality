...
public class Cabbage extends BrutalityAbstractPhysicsTrident implements BrutalityGeoEntity {


    public Cabbage(EntityType<? extends BrutalityAbstractTrident> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public Cabbage(EntityType<? extends BrutalityAbstractTrident> pEntityType, Player player, Level pLevel) {
