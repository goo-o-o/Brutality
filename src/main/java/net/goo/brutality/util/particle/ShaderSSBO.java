...
public class ShaderSSBO {
	...
	public ShaderSSBO() {
		if (!Shaders.supportSSBO()) {
			...
			Brutality.LOGGER.error(errorMessage);
	...
	public void close() {
		if (!inValid) {
			...
			Brutality.LOGGER.error("try closing an already closed ShaderStorageBufferObject");
		}
	}
	...
	public void bindBuffer() {
		if (!inValid){
			...
			Brutality.LOGGER.error("try to use an already close ShaderStorageBufferObject");
		}
	}
