...
public record ItemDescriptionComponent(
    ...
    public enum ItemDescriptionComponents {
        ACTIVE, PASSIVE, FULL_SET_PASSIVE, FULL_SET_ACTIVE, ON_HIT, WHEN_THROWN, ON_SWING, ON_LEFT_CLICKING_ENTITY, ON_RIGHT_CLICK, ON_RELEASE_RIGHT_CLICK, ON_SHIFT_RIGHT_CLICK, LORE, ON_KILL, ON_SHOOT, ON_HOLD_RIGHT_CLICK, CHARM, DASH_ABILITY, ON_SUCCESSFUL_DODGE, MANA_COST
    }
}
