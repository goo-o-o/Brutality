...
public interface ModResources {
    ...
    UUID BASE_MOVEMENT_SPEED_UUID = UUID.fromString("49949eb8-6cc1-4103-8c7c-e953598eb211");
    UUID BASE_ATTACK_SPEED_FOR_EFFECT_UUID = UUID.fromString("7e386036-2113-49ed-b32c-bdaf57ade2c8");
    UUID BASE_ATTACK_DAMAGE_FOR_EFFECT_UUID = UUID.fromString("fa628962-7dc1-4f95-8c04-d98348731dfe");
    ...
    int[][] CREASE_OF_CREATION_COLORS = new int[][] {{65, 62, 146}, {15, 15, 70}};
...
//                    Map.entry(DivineRhittaAxeItem.class, RHITTA_COLORS),
            Map.entry(BrutalityTridentItem.class, new int[][]{{0,0,0}, {0,0,0}}),
            ...
            Map.entry(HFMurasamaSword.class, MURASAMA_COLORS),
            ...
            Map.entry(CreaseOfCreationItem.class, CREASE_OF_CREATION_COLORS),
            Map.entry(SpatulaHammer.class, NOIR_COLORS),
            Map.entry(FryingPanHammer.class, NOIR_COLORS)
