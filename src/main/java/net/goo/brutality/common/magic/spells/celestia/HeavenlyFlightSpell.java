...
public class HeavenlyFlightSpell extends BrutalitySpell {
    ...
    public HeavenlyFlightSpell() {
        super(MagicSchool.CELESTIA,
                ...
                50, 0, 200, 0, 1, List.of(
                        new SpellTooltipRenderer.SpellStatComponent(SpellTooltipRenderer.SpellStatComponentType.DURATION, 200, 100, null, null)
                ));
    }
    ...
    public boolean onStartCast(Player player, ItemStack stack, int spellLevel) {
        float duration = getFinalStat(spellLevel, getStat(SpellTooltipRenderer.SpellStatComponentType.DURATION));
