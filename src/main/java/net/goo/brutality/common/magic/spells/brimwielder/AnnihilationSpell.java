...
import net.goo.brutality.common.entity.spells.brimwielder.AnnihilationEntity;
    ...
    public boolean onStartCast(Player player, ItemStack stack, int spellLevel) {
        ...
        if (player.level() instanceof ServerLevel serverLevel) {
            ...
            for (Vec3 finalPos : lancePositions) {
                AnnihilationEntity annihilationEntity = new AnnihilationEntity(BrutalityEntities.ANNIHILATION_ENTITY.get(), serverLevel);
            ...
            FlatParticleData<?> data = new FlatParticleData<>(BrutalityParticles.HEXING_CIRCLE_PARTICLE.get(), radius);
