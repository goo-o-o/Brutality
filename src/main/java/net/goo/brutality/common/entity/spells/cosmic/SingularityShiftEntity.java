    ...
    protected void onHit(@NotNull HitResult hitResult) {
        ...
        if (level() instanceof ServerLevel serverLevel) {
            serverLevel.sendParticles(
                    BrutalityParticles.COSMIC_PARTICLE.get(0).get(), this.getX(), this.getY(), this.getZ(),
                    2, 0.25, 0.25, 0.25, 0);
            serverLevel.sendParticles(
                    BrutalityParticles.COSMIC_PARTICLE.get(1).get(), this.getX(), this.getY(), this.getZ(),
                    2, 0.25, 0.25, 0.25, 0);
            ...
            if (tickCount % 5 == 0) {
                ...
                entities.forEach(e -> {
                    ...
                    MobEffectInstance effectInstance = new MobEffectInstance(
                            isWeightless() ? BrutalityEffects.WEIGHTLESSNESS.get() : BrutalityEffects.HYPERGRAVITY.get(),
                            6,
                            getSpellLevel(),
                            false, true
                    );
