package net.goo.brutality.common.entity.mobs;

import net.goo.brutality.common.entity.capabilities.goals.*;
import net.goo.brutality.common.registry.BrutalityEntities;
import net.goo.brutality.util.OwnerHelper;
...
public class SummonedStray extends Stray implements ISummon {
    ...
    public SummonedStray(Level level, LivingEntity owner, boolean playRiseAnimation) {
        this(BrutalityEntities.SUMMONED_STRAY.get(), level);
        setSummoner(owner);
    }
