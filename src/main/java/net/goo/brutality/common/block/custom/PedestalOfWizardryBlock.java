...
public class PedestalOfWizardryBlock extends BaseEntityBlock {
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        ...
        if (pLevel.getBlockEntity(pedestal.getTableOfWizardryPosition()) instanceof TableOfWizardryBlockEntity tableOfWizardryBlockEntity) {
            if (tableOfWizardryBlockEntity.isCrafting) return InteractionResult.PASS;
        }
