...
public class ManaCauldronBlock extends LayeredCauldronBlock {
    public static final Predicate<Biome.Precipitation> MANA = (precipitation) -> false;

    public ManaCauldronBlock(Properties pProperties) {
        super(pProperties, MANA, BrutalityCauldronInteraction.MANA_INTERACTIONS);
    }
