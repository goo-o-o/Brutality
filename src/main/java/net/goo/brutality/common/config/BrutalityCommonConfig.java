...
package net.goo.brutality.common.config;
...
public class BrutalityCommonConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue VANILLA_CRITS;

    public static final ForgeConfigSpec.DoubleValue BASIC_STAT_TRAK_CHANCE;
    public static final ForgeConfigSpec.DoubleValue GOLDEN_STAT_TRAK_CHANCE;
    public static final ForgeConfigSpec.DoubleValue PRISMATIC_STAT_TRAK_CHANCE;

    public static final ForgeConfigSpec.DoubleValue MAXIMUM_NETHER_COINS;
    public static final ForgeConfigSpec.DoubleValue MAXIMUM_END_COINS;
    public static final ForgeConfigSpec.DoubleValue PORTABLE_MINING_RIG_GENERATION_FACTOR;
    static {
        BUILDER.push("Portable Mining Rig");
        {
            MAXIMUM_NETHER_COINS = BUILDER.comment("Maximum Nether Coins generated")
                    .defineInRange("maxNetherCoins", 25F, 0, 1000);
            MAXIMUM_END_COINS = BUILDER.comment("Maximum End Coins generated")
                    .defineInRange("maxEndCoins", 1.5F, 0, 1000);

            PORTABLE_MINING_RIG_GENERATION_FACTOR = BUILDER.comment("Portable Mining Rig generation factor")
                    .defineInRange("generationFactor", 1F, 0, 1000);
        ...
        BUILDER.push("Explosions & Griefing");
        {
        ...
        {
            BASIC_STAT_TRAK_CHANCE = BUILDER.comment("Chance (%) to attach a Basic StatTrakker™ any crafted item")
                    .defineInRange("basicStatTrakChance", 15F, 0, 100);
            GOLDEN_STAT_TRAK_CHANCE = BUILDER.comment("Chance (%) to attach a Golden StatTrakker™ any crafted item")
                    .defineInRange("goldenStatTrakChance", 10F, 0, 100);
            PRISMATIC_STAT_TRAK_CHANCE = BUILDER.comment("Chance (%) to attach a Prismatic StatTrakker™ any crafted item")
                    .defineInRange("prismaticStatTrakChance", 5F, 0, 100);
        }
        BUILDER.pop();
