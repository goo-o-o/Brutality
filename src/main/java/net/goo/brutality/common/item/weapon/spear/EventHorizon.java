...
public class EventHorizon extends BrutalitySpearItem {
    ...
    public void spawnBlackHole(Player player, ItemStack pStack) {
        if (player.level() instanceof ServerLevel serverLevel) {
            serverLevel.playSound(null, player.getOnPos(), BrutalitySounds.EVENT_HORIZON_DISLODGE.get(), SoundSource.AMBIENT);

            BlackHole blackHole = new BlackHole(BrutalityEntities.BLACK_HOLE_ENTITY.get(), serverLevel);
...
//            System.out.println(blackHole);
            if (blackHole != null) {
                serverLevel.playSound(null, player.getOnPos(), BrutalitySounds.EVENT_HORIZON_RETURN.get(), SoundSource.AMBIENT);
                blackHole.discard();
            }
