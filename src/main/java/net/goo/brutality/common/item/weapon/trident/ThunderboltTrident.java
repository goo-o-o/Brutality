...
public class ThunderboltTrident extends BrutalityTridentItem {
    ...
    public void launchProjectile(Level pLevel, Player player, ItemStack pStack) {
        ...
        if (j == 0) {
            ThrownThunderbolt thrownThunderbolt = new ThrownThunderbolt(pLevel, player, pStack, BrutalityEntities.THROWN_THUNDERBOLT_ENTITY.get());
            ...
            if (!player.getAbilities().instabuild && !net.goo.brutality.util.EnchantmentHelper.hasInfinity(pStack)) {
    ...
    public boolean isBookEnchantable(ItemStack stack, ItemStack book) {
        return net.goo.brutality.util.EnchantmentHelper.restrictEnchants(book, ALLOWED_ENCHANTMENTS);
    }
}
