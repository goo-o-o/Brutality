...
import net.goo.brutality.common.entity.projectile.generic.ShadowflameSlash;
...
public class ShadowflameScissorBlade extends BrutalitySwordItem {
    ...
    public void performShadowflameSlash(Player player) {
        ...
        ShadowflameSlash shadowflameSlash = new ShadowflameSlash(BrutalityEntities.SHADOWFLAME_SLASH.get(), level);
