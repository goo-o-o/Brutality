...
public class VoidKnifeSword extends BrutalitySwordItem {
    ...
    public VoidKnifeSword(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
    ...
    public boolean hurtEnemy(ItemStack pStack, LivingEntity pTarget, LivingEntity pAttacker) {
        ...
        if (pTarget.hasEffect(BrutalityEffects.SCORED.get())) {
            int amplifier = Objects.requireNonNull(pTarget.getEffect(BrutalityEffects.SCORED.get())).getAmplifier();
        ...
        pTarget.addEffect(new MobEffectInstance(BrutalityEffects.PULVERIZED.get(), 3, 3));
