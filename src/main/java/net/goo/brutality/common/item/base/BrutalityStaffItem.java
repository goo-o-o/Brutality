...
public class BrutalityStaffItem extends AxeItem implements BrutalityGeoItem {
    ...
    public BrutalityStaffItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
