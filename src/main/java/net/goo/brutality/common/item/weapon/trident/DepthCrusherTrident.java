...
import net.goo.brutality.common.entity.projectile.trident.physics_projectile.DepthCrusher;
...
public class DepthCrusherTrident extends BrutalityTridentItem {
    ...
    public void launchProjectile(Level pLevel, Player player, ItemStack pStack) {
        ...
        DepthCrusher thrownEntity = new DepthCrusher(BrutalityEntities.DEPTH_CRUSHER.get(), player, pLevel);
