package net.goo.brutality.common.item.weapon.sword.phasesaber;
...
public class BasePhasesaber extends BrutalitySwordItem {
    ...
    public boolean onEntitySwing(ItemStack stack, LivingEntity entity) {
        if (!ModList.get().isLoaded("bettercombat") && entity instanceof Player player && player.getAttackStrengthScale(0) > 0.9)
            entity.playSound(BrutalitySounds.PHASESABER_SWING.get(), 1.0F, 1.0F);
