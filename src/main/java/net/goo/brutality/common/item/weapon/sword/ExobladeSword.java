...
public class ExobladeSword extends BrutalitySwordItem {
    ...
    public boolean onEntitySwing(ItemStack stack, LivingEntity entity) {
        ...
        entity.level().playSound(null, entity.blockPosition(), ModUtils.getRandomSound(BrutalitySounds.EXOBLADE), SoundSource.PLAYERS, 1, Mth.nextFloat(entity.level().getRandom(), 0.5F, 1.25F));
...
//            } else {
            for (int i = 0; i < 4; i++)
                ProjectileHelper.shootProjectile(() -> new ExobladeBeam(BrutalityEntities.EXOBLADE_BEAM.get(), level), player, level, 2F, true, 1.5F, 0);
//        }
        }
    }
