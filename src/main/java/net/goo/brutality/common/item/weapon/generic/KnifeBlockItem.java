...
public class KnifeBlockItem extends BrutalityGenericItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (pLevel instanceof ServerLevel serverLevel) {
            if (!availableKnives.isEmpty()) {
                ...
                pLevel.playSound(null, pPlayer.getOnPos(), BrutalitySounds.KNIFE_BLOCK.get(), SoundSource.PLAYERS);
            } else {
    ...
    public void launchProjectile(Level pLevel, Player player, ItemStack pStack, String knifeType) {
        ...
        ThrownKnife thrownKnife = new ThrownKnife(pLevel, player, pStack, BrutalityEntities.THROWN_KNIFE_ENTITY.get(), knifeType);
