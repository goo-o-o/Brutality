...
public class QuickSilver extends BrutalityCoinItem {


    public QuickSilver(Properties pProperties, int cooldownTime, List<ItemDescriptionComponent> descriptionComponents) {
    ...
    public void onHeads(Player player, ItemStack stack, Vec3 location) {
        ...
        player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 80, 9));
    }
