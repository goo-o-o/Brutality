...
public class SpatulaHammer extends BrutalityHammerItem implements BrutalityGeoItem {
    ...
    public SpatulaHammer(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
    ...
    public boolean hurtEnemy(ItemStack pStack, @NotNull LivingEntity pTarget, @NotNull LivingEntity pAttacker) {
        ...
        pTarget.addEffect(new MobEffectInstance(BrutalityEffects.MASHED.get(), 60, 0, false, true));
        pTarget.addEffect(new MobEffectInstance(BrutalityEffects.SCORED.get(), 60, 0, false, true));
