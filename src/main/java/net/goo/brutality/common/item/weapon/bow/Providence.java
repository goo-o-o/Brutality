package net.goo.brutality.common.item.weapon.bow;

import net.goo.brutality.Brutality;
import net.goo.brutality.common.item.base.BrutalityBowItem;
...
public class Providence extends BrutalityBowItem {
    ...
    protected SoundEvent getShootSound() {
        return BrutalitySounds.WINGS_FLAP.get();
    }

    @Override
    protected EntityType<? extends AbstractArrow> getArrowEntity() {
        return BrutalityEntities.LIGHT_ARROW.get();
    }
