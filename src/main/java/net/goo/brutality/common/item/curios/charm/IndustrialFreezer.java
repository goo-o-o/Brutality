...
public class IndustrialFreezer extends BrutalityGastronomyCurioItem {


    public IndustrialFreezer(Rarity rarity, List<ItemDescriptionComponent> descriptionComponents) {
