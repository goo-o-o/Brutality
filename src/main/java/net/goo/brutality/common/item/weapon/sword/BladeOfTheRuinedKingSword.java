...
public class BladeOfTheRuinedKingSword extends BrutalitySwordItem {
    ...
    public void releaseUsing(ItemStack pStack, Level pLevel, LivingEntity pLivingEntity, int pTimeCharged) {
        ...
        if (!pLevel.isClientSide) {
            SpectralMawEntity spectralMaw = new SpectralMawEntity(BrutalityEntities.SPECTRAL_MAW_ENTITY.get(), pLivingEntity, pLevel, 72000 - pTimeCharged);
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlot slot, ItemStack stack) {
        ...
        if (slot == EquipmentSlot.MAINHAND || slot == EquipmentSlot.OFFHAND) {
            ...
            newAttributes.put(BrutalityAttributes.LIFESTEAL.get(),
                    new AttributeModifier(BORK_LIFESTEAL_UUID, "Lifesteal buff", 0.1, AttributeModifier.Operation.ADDITION));
