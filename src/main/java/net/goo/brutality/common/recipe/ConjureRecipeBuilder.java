...
public class ConjureRecipeBuilder {
    ...
    public ConjureRecipeBuilder count(int count) {
        this.count = count;
        return this;
    }
    ...
    public ConjureRecipeBuilder requires(int slot, ItemStack item) {
        this.ingredients.set(slot, Ingredient.of(item));
        return this;
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer) {
        ...
        consumer.accept(new Result(this.spellId, ingredients, entities, mana, count));
    }
    ...
    private record Result(ResourceLocation id, NonNullList<Ingredient> ingredients,
                          List<EntityType<?>> entityTypes, int mana, int outputCount) implements FinishedRecipe {
        @Override
