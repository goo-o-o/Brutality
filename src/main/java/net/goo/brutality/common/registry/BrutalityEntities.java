...
import net.goo.brutality.common.entity.projectile.trident.physics_projectile.*;
import net.goo.brutality.common.entity.spells.brimwielder.*;
import net.goo.brutality.common.entity.projectile.ray.ExplosionRay;
import net.goo.brutality.common.entity.projectile.ray.LastPrismRay;
import net.goo.brutality.common.entity.projectile.trident.ExobladeBeam;
import net.goo.brutality.common.entity.projectile.trident.ThrownGungnir;
import net.goo.brutality.common.entity.projectile.trident.ThrownKnife;
...
//                    MobCategory.MISC).sized(1F, 0.25F).build("sword_wave"));
    ...
    public static final RegistryObject<EntityType<ThrownStickyBomb>> STICKY_BOMB =
            ENTITY_TYPES.register("sticky_bomb", () -> EntityType.Builder.of(
                    (EntityType<ThrownStickyBomb> entityType, Level level) -> new ThrownStickyBomb(entityType, level, BrutalityDamageTypes.THROWING_BLUNT),
    ...
    public static final RegistryObject<EntityType<RhongomyniadRay>> RHONGOMYNIAD_RAY =
            ENTITY_TYPES.register("rhongomyniad_ray", () -> EntityType.Builder.of(RhongomyniadRay::new,
                            ...
                            new RhongomyniadRay(BrutalityEntities.RHONGOMYNIAD_RAY.get(), level))
