...
public class ClientProxy {
    ...
    public static void startMaxAttack(int entityId) {
        if (mc.level != null) {
    ...
    public static void playExtinctionSpellSound(ExtinctionEntity extinctionEntity) {
        ClientProxy.extinctionSpellSoundInstance = new ExtinctionSpellSoundInstance(extinctionEntity);
        mc.getSoundManager().queueTickingSound(ClientProxy.extinctionSpellSoundInstance);
    }
    ...
    public static void startDeathsawSound(Player player) {
        ClientProxy.deathsawSoundInstance = new DeathsawSoundInstance(player);
        ...
        if (deathsawSoundInstance.canPlaySound() && !soundManager.isActive(deathsawSoundInstance))
            mc.getSoundManager().playDelayed(ClientProxy.deathsawSoundInstance, 23);
    }
    ...
    public static void stopDeathsawSound(LivingEntity livingEntity) {
        ...
        if (soundManager.isActive(deathsawSoundInstance))
            soundManager.stop(ClientProxy.deathsawSoundInstance);
    }
