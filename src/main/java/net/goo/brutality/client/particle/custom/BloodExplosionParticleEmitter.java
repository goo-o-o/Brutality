...
public class BloodExplosionParticleEmitter extends NoRenderParticle {
    ...
    public void tick() {
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            this.level.addParticle(BrutalityParticles.BLOOD_EXPLOSION_PARTICLE.get(), d0, d1, d2, (float) this.life / (float) lifeTime, 0.0D, 0.0D);
            this.level.addParticle(BrutalityParticles.BLOOD_PARTICLE.get(), d0, d1, d2, 1,1,1);
        }
