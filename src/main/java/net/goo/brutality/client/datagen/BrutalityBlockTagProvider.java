...
public class BrutalityBlockTagProvider extends BlockTagsProvider {
    public BrutalityBlockTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.CANDLE_CAKES).add(BrutalityBlocks.MANA_CANDLE_CAKE.get());
