...
public class BrutalityAutoAlphaTexture extends AutoGlowingTexture {
    ...
    public BrutalityAutoAlphaTexture(ResourceLocation originalLocation, ResourceLocation location) {
    ...
    private static final Function<ResourceLocation, RenderType> RENDER_TYPE_FUNCTION = Util.memoize((texture) -> {
        ...
        return RenderType.create("brutality_alpha_texture",
    ...
    private static ResourceLocation getEmissiveResource(ResourceLocation baseResource) {
        ResourceLocation path = appendToPath(baseResource, "_t");
