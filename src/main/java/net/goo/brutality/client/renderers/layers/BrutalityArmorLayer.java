...
public class BrutalityArmorLayer<T extends ArmorItem & BrutalityGeoItem> extends GeoRenderLayer<T> {
    public final GeoArmorRenderer<T> geoRenderer;

    public BrutalityArmorLayer(GeoArmorRenderer<T> entityRendererIn) {
