...
public class BrutalityEmissiveTranslucentNoCullItemRenderer<T extends Item & BrutalityGeoItem> extends BrutalityEmissiveItemRenderer<T> {

    public BrutalityEmissiveTranslucentNoCullItemRenderer() {
        super();
