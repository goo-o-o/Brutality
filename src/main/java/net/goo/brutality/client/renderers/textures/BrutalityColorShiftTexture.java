...
public class BrutalityColorShiftTexture extends BrutalityAutoFullbrightNoDepthTexture {

    public BrutalityColorShiftTexture(ResourceLocation originalLocation, ResourceLocation location) {
        super(originalLocation, location);
    }

    public static RenderType getRenderType(ResourceLocation texture) {
//        return RenderType.entityCutout(getEmissiveResource(texture));
        return BrutalityRenderTypes.FULLBRIGHT_NO_DEPTH.apply(getEmissiveResource(texture));
    }
