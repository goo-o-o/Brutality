...
import net.goo.brutality.client.renderers.textures.BrutalityAutoFullbrightTexture;
...
public class BrutalityAutoFullbrightLayer<T extends GeoAnimatable> extends AutoGlowingGeoLayer<T>{
    ...
    protected RenderType getRenderType(T animatable) {
        return BrutalityAutoFullbrightTexture.getRenderType(this.getTextureResource(animatable));
    }
