package net.goo.arma.entity.client;
...
public class SupernovaExplosionRenderer extends EntityRenderer<SupernovaExplosionEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Arma.MOD_ID, "textures/entity/supernova_explosion.png");
