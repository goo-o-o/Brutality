...
public class TestTridentItem extends TridentItem implements Vanishable {
    public TestTridentItem(Properties pProperties) {
        super(pProperties);
    }
            ...
            if (i >= 10) {
                ...
                if (j <= 0 || player.isInWaterOrRain()) {
                    if (!pLevel.isClientSide) {
                        ...
                        if (j == 0) {
                            TestTridentEntity throwntrident = new TestTridentEntity(pLevel, player, pStack);
