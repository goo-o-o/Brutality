...
public class ThunderboltTrident extends ArmaTridentItem implements Vanishable {
    ...
    public void launchProjectile(Level pLevel, Player player, ItemStack pStack) {
        ...
        if (j == 0) {
            ...
            if (!player.getAbilities().instabuild && !net.goo.armament.util.helpers.EnchantmentHelper.hasInfinity(pStack)) {
    ...
    public boolean isBookEnchantable(ItemStack stack, ItemStack book) {
        return net.goo.armament.util.helpers.EnchantmentHelper.restrictEnchants(book, ALLOWED_ENCHANTMENTS);
    }
}
