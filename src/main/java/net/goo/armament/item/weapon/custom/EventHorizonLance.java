...
public class EventHorizonLance extends ArmaTridentItem implements Vanishable {
    ...
    public EventHorizonLance(Properties pProperties, String identifier, ModItemCategories category, Rarity rarity, int abilityCount) {
        ...
        if (blackHoleEntity != null) {
            ...
            if (droppedInventory != null) {
                for (ItemEntity droppedItem : droppedInventory) {
                    ...
                    if (itemStack.getItem() instanceof EventHorizonLance) {
            ...
            if (blackHoleEntity != null) {
                if (pIsSelected) {
                    if (isSpawned(pStack)) {
                        ...
                        player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 2, 50, true, true), player);
                        player.addEffect(new MobEffectInstance(MobEffects.JUMP, 2, 128, true, true), player);
