...
public class QuantumDrillItem extends ArmaGenericItem {
    ...
    public QuantumDrillItem(Properties pProperties, String identifier, ModItemCategories category, Rarity rarity, int abilityCount) {
            ...
            if (tickCount % 15 == 0) {
                ...
                pPlayer.displayClientMessage(Component.literal
                        ...
                        (Component.literal(String.format("%.2f", efficiencyPercentage) + "% efficiency")
                                .withStyle(Style.EMPTY.withColor(ModTooltipHelper.getColorFromGradient((int) efficiencyPercentage, efficiencyColor3, efficiencyColor2, efficiencyColor1)).withBold(true))),
                        true);
