package net.goo.armament.entity.capabilities;

import net.goo.armament.entity.capabilities.goals.OwnerGetter;
...
public class GenericCopyOwnerTargetGoal extends TargetGoal {
    ...
    public boolean canUse() {
        return ownerGetter.get() instanceof Mob owner && owner.getTarget() != null;
    }
