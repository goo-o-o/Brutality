package net.goo.armament.entity.client.model;// Made with Blockbench 4.12.2
...
public class CruelSun2Model<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Armament.MOD_ID, "cruel_sun"), "main");
	private final ModelPart main;
	private final ModelPart ring;
	private final ModelPart cruel_sun;

	public CruelSun2Model(ModelPart root) {
