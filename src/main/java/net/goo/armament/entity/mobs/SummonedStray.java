package net.goo.armament.entity.mobs;

import net.goo.armament.entity.capabilities.GenericCopyOwnerTargetGoal;
import net.goo.armament.entity.capabilities.GenericHurtByTargetGoal;
import net.goo.armament.entity.capabilities.GenericOwnerHurtByTargetGoal;
