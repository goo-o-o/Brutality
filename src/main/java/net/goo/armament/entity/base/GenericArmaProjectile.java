...
public class GenericArmaProjectile extends ThrowableProjectile implements ArmaGeoEntity {
    public String identifier;


    public GenericArmaProjectile(EntityType<? extends ThrowableProjectile> pEntityType, Level pLevel) {
