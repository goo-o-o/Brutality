package net.goo.armament.particle.base.sword_waves;
...
public class SwordWaveParticle extends TextureSheetParticle {
    ...
    private long lastUpdateTime = System.nanoTime(); // Tracks the last update time
    private static final float NANOS_TO_SECONDS = 1.0F / 1_000_000_000.0F;

    protected SwordWaveParticle(ClientLevel world, double x, double y, double z, SpriteSet sprites) {
    ...
    public void render(VertexConsumer buffer, Camera camera, float ticks) {
        ...
        float deltaTime = (currentTime - lastUpdateTime) * NANOS_TO_SECONDS;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new SwordWaveParticle(level, x, y, z, this.sprites);
        }
    }
