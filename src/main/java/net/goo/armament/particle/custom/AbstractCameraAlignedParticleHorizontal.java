...
public abstract class AbstractCameraAlignedParticleHorizontal extends AbstractTrailParticle {

    public AbstractCameraAlignedParticleHorizontal(ClientLevel world, double x, double y, double z, double xd, double yd, double zd, float r, float g, float b) {
