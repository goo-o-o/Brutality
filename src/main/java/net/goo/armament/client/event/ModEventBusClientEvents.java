...
import net.goo.armament.client.event.entity.ModModelLayers;
import net.goo.armament.client.event.entity.model.CruelSunModel;
import net.goo.armament.client.event.entity.model.ThrownZeusThunderboltModel;
import net.goo.armament.client.event.entity.renderer.BlackHoleRenderer;
import net.goo.armament.client.event.entity.renderer.CruelSunRenderer;
import net.goo.armament.client.event.entity.renderer.TerraBeamRenderer;
import net.goo.armament.client.event.entity.renderer.ThrownZeusThunderboltRenderer;
