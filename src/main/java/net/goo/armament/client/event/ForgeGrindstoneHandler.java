...
public class ForgeGrindstoneHandler {
    ...
    public static void onGrindstoneUse(GrindstoneEvent.OnPlaceItem event) {
        ...
        } else if (targetStack.getItem() == ModItems.TERRATON_HAMMER.get()) {
            handleGrindstoneEvent(
                    event,
                    targetStack,
        ...
        } else if (targetStack.getItem() instanceof ArmaScytheItem) {
            handleGrindstoneEvent(
                    event,
                    targetStack,
        ...
        } else if (targetStack.getItem() == ModItems.SUPERNOVA_SWORD.get()) {
            handleGrindstoneEvent(
                    event,
                    targetStack,
                    Map.of(Enchantments.SWEEPING_EDGE, 5), // Allowed enchantments
