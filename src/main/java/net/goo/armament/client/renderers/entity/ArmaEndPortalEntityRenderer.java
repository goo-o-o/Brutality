...
public class ArmaEndPortalEntityRenderer<T extends Entity & ArmaGeoEntity> extends GeoEntityRenderer<T> {
    public ArmaEndPortalEntityRenderer(EntityRendererProvider.Context context) {
