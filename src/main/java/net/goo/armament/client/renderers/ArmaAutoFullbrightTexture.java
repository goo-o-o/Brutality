...
public class ArmaAutoFullbrightTexture extends AutoGlowingTexture {
    ...
    public ArmaAutoFullbrightTexture(ResourceLocation originalLocation, ResourceLocation location) {
