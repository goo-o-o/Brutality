...
public class ArmaAutoGlowingTranslucentNoCullItemRenderer<T extends Item & ArmaGeoItem> extends ArmaAutoGlowingItemRenderer<T> {

    public ArmaAutoGlowingTranslucentNoCullItemRenderer() {
        super();
