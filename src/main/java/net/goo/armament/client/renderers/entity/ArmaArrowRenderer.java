...
public class ArmaArrowRenderer<T extends ArmaArrow & ArmaGeoEntity> extends ArmaEntityRenderer<T> {
    public ArmaArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
